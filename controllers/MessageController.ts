...
export default class MessageController implements MessageControllerI {
    ...
    public static getInstance = (app: Express): MessageController => {
        if (MessageController.messageController === null) {
            ...
            app.post("/api/users/:uid1/messages/:uid2", MessageController.messageController.userSendMessage);
            ...
            app.delete("/api/users/:uid/messages/sent", MessageController.messageController.userDeletesAllSentMessages);
            app.delete("/api/users/:uid/messages/received", MessageController.messageController.userDeletesAllReceivedMessages);
        }
    ...
    userSendMessage = (req: Request, res: Response) =>
        MessageController.messageDao.userSendMessage(req.params.uid1, req.params.uid2, req.body)
