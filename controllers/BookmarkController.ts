 ...
 * <ul>
 *     <li>POST /api/users/:uid/bookmarks/:tid user bookmarks a tuit
 *     </li>
 *     <li>DELETE /api/users/:uid/bookmarks/:tid user unbookmarks a tuit
 *     </li>
 *     <li>GET /api/users/:uid/bookmarks retrieve all the tuits bookmarked by a user
 *     </li>
 *     <li>GET /api/tuits/:tid/bookmarks User views a list of users that bookmarked a tuit
 *     </li>
 *     <li>DELETE /api/users/:uid/bookmarks/ user unbookmarks all tuit
 *     </li>
 * </ul>
...
export default class BookmarkController implements BookmarkControllerI {
    ...
    /**
         ...
         * path parameters uid and tid representing the user bookmarking tuit
